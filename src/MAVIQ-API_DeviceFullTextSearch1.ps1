<#
.SYNOPSIS
Search for all terms that start with 'win' in all searchable fields and return the first 100 devices that match that search
#>
[CmdletBinding()]
param()
...
$query = [PSCustomObject]@{
    ...
    skip = 0
    top = 100
    select = "deviceName,osWindowsMajorVersion"
